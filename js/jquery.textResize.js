/*
 to use this plugin to change the font size of the text in a TextArea use:-
 1. ID of the textarea as  "tex".
 
 To Show the no of characters remaining use the 
 1. ID of the span/div or user field as "dispremain"
 
 This jquery plugin comes in with a textResize.css that must be present in the "css" folder in the same directory.
